    ...
    Column {
        ...
        Text {
            ...
            text: {
                ...
                var cnt = 0
                var alle = panel.canvas.elementeModel.snapshot()
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        TextInput {
                            ...
                            Binding on text { when: !mkOxTf.activeFocus; value: Math.round(mkOxTf.weltWert / panel.canvas.mmToPx); delayed: true }
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        TextInput {
                            ...
                            text: Math.round(weltWert / panel.canvas.mmToPx)
                            Binding on text { when: !mkOyTf.activeFocus; value: Math.round(mkOyTf.weltWert / panel.canvas.mmToPx); delayed: true }
