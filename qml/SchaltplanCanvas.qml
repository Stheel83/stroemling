...
Item {
    ...
    Canvas {
                ...
                for (var si = 0; si < net.segmente.length; si++) {
                    ...
                    if (t >= -0.005 && t <= 1.005 && s >= -0.005 && s <= 1.005) {
                        schnitte.push({
                            ...
                            aderKey:      netzHandler._lokalerAderSchluessel(seg, net, elemente),
        ...
        function maleAutoVerbindungen(ctx, netze) {
            if (netze === undefined) netze = netzHandler.autoNetzeBerechnenCached()
    ...
    function kabelSchnittNetzeBerechnen(el) {
        return drawCanvas.kabelSchnittNetzeBerechnen(el, netzHandler.autoNetzeBerechnen())
    }
