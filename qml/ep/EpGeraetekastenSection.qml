                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        TextInput {
                            ...
                            Binding on text { when: !gkOxTf.activeFocus; value: Math.round(gkOxTf.weltWert / panel.canvas.mmToPx); delayed: true }
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        TextInput {
                            ...
                            text: Math.round(weltWert / panel.canvas.mmToPx)
                            Binding on text { when: !gkOyTf.activeFocus; value: Math.round(gkOyTf.weltWert / panel.canvas.mmToPx); delayed: true }
