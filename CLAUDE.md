...
| `konzept/projekt/release_checkliste.md` | Release-Checkliste (GitHub-Actions-Workflow ab v0.67): Doppel-Push origin+github, GLIBC-Vorbehalt AppImage, manuelle Tests, Codeberg/GitHub-Release, Website-Deploy | ✅ |
