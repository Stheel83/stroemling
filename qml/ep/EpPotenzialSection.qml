                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        TextInput {
                            ...
                            Binding on text { when: !paOxTf.activeFocus; value: Math.round(paOxTf.weltWert / panel.canvas.mmToPx); delayed: true }
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        TextInput {
                            ...
                            text: Math.round(weltWert / panel.canvas.mmToPx)
                            Binding on text { when: !paOyTf.activeFocus; value: Math.round(paOyTf.weltWert / panel.canvas.mmToPx); delayed: true }
