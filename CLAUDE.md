...
| `konzept/architektur/50_strukturkennzeichen.md` | Zentrales Strukturkennzeichen-System: ==, =, ++, + — Seitenbaum als Struktureditor, Dropdowns in allen Elementen, Implementierungsreihenfolge | 🔄 Kernsystem ✅, SEITENSTRUKTUR-01 offen |
