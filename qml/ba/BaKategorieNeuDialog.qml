...
Dialog {
    ...
    contentItem: ColumnLayout {
        spacing: 10
        Text { text: qsTr("Neue Kategorie"); font.pixelSize: 15; font.weight: Font.Medium; color: root.theme.textPrimary }
        ...
        RowLayout {
            ...
            Button {
                ...
                onClicked: {
                    kategorieModel.anlegen(root.parentId, inpKatName.text.trim())
                    inpKatName.text = ""
                    root.close()
                }
            }
