                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        TextInput {
                            ...
                            Binding on text { when: !skOxTf.activeFocus; value: Math.round(skOxTf.weltWert / panel.canvas.mmToPx); delayed: true }
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        TextInput {
                            ...
                            text: Math.round(weltWert / panel.canvas.mmToPx)
                            Binding on text { when: !skOyTf.activeFocus; value: Math.round(skOyTf.weltWert / panel.canvas.mmToPx); delayed: true }
