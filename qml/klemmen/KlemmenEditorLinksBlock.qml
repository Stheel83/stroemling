...
// vorher scrollte der Speichern-Button mit den Feldern mit und war bei diesem
// langen Formular erst nach Hochscrollen sichtbar. Gleiches Muster in
// KabelEditorLinksBlock.qml, SteckverbinderEditor.qml, KontaktEditor.qml,
// KonfkabelEditor.qml.
ColumnLayout {
    id: root
    spacing: 0
    ...
    ScrollView {
        ...
        // erzwingen, damit bei diesem langen Formular sichtbar wird, dass
